import wave
import struct
import huff_2017A7PS0118P_D9 as huff
import os
...
class encode_audio:
    ...
    def compression(self):
        ...
        os.remove(self.inter_path_name+ "_compressed" + "_1" + self.inter_path_extension)

        if self.has_2_channels:
            encode_2 = huff.huff_man(self.inter_path_name+ "_compressed" +"_2" + self.inter_path_extension)
            encode_2.compress()
            os.remove(self.inter_path_name+ "_compressed" + "_2" + self.inter_path_extension)
...
if __name__ == "__main__":
    test = encode_audio("sample_2017A7PS0118P_D9.wav")
    test.diff_encoding()
